...
function main(workbook) {
    ...
    const dataRows = sourceTable.getRangeBetweenHeaderAndTotal().getValues();
    // Create variables to hold the rows to be moved and their addresses
    let rowsToMoveValues = [];
    let rowAddressToRemove = [];
...
function reApplyFilters(sourceTable, columnNameFilteredOn, tableFilters) {
    // Re-apply all column filters
